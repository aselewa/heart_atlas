...
png(file="eQTL_power.png",  width = 1500, height=1500, res=300)

plot(PVE, power, type="l", col=colors[1], ylab="Power")
...
legend("topleft", c(expression(pi[CM] == 1), expression(pi[CM] == 0.5), expression(pi[CM] == 0.3)), col=colors,lty=1, cex=1.0)
